...
import gzt.manus.findqueuke.Drawing.BorderedText;
import gzt.manus.findqueuke.Drawing.MultiBoxTracker;
import gzt.manus.findqueuke.Drawing.OverlayView;
...
import gzt.manus.findqueuke.LiveFeed.CameraConnectionFragment;
import gzt.manus.findqueuke.LiveFeed.ImageUtils;
...
public class CameraActivity extends AppCompatActivity implements ImageReader.OnImageAvailableListener{
    ...
    public void performFaceRecognition(Face face,Bitmap input){
        ...
        if (bounds != null) {
            ...
            Log.d("tryFR",recognition.getTitle()+""+confidence);
    ...
    private void registerFaceDialogue(Bitmap croppedFace, FaceClassifier.Recognition rec) {
        ...
        dialog.setContentView(R.layout.register_face_dialogue_cam);
